package com.example.henry.ighubchurchapp.notespad;
...
import com.example.henry.ighubchurchapp.HomePage;
import com.example.henry.ighubchurchapp.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(NotesPad.this, HomePage.class);
                startActivity(i);
                finish();
            }
        });
